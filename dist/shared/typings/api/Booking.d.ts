...
export declare type BookingServerParamsPatch = DatePropsToUnix<UseParameters<BookingAttributes, never, "userId" | "paid" | "amount" | "from" | "to" | "approved" | "finished" | "startMileage" | "endMileage" | "startFuel" | "endFuel" | "vehicleId" | "bookingType" | "returnDate" | "pickupDate"> & {

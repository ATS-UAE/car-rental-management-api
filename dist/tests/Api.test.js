...
describe("Api", function () {
    ...
    var BASE_URL = "https://www.example.com/api";
    describe("auth", function () {
        var LOGIN_URL = BASE_URL + "/auth/login";
        var LOGIN_METHOD = "post";
        var COOKIE_SESSION = "connect.sid=s%3AZvvHUU93a0rEb7WgfwH79WGtW_ACjM1J.GzEwEsVFFpJDIlJJYaaZPb%2F%2FfHMrVvNyzskVWUBl1hs";
        var LOGIN_RESPONSE = post_1.default();
        it("Logs in", function () { return __awaiter(void 0, void 0, void 0, function () {
            var api, mostRecentApiCall;

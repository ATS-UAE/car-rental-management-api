...
exports.createBookingInstance = function (data, meta) {
    if (data === void 0) { data = {}; }
    if (meta === void 0) { meta = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var api, VEHICLE_ID, GET_ONE_RESPONSE;

import { LocationServerParamsPost, LocationServerParamsPatch, LocationServerResponseGet } from "car-rental-management-shared";
...
export declare class LocationFactory extends Authenticated {
    ...
    fromObject: (data: LocationServerResponseGet["data"]) => Location;
}

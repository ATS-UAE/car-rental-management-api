...
var WialonUnit = /** @class */ (function () {
    ...
    WialonUnit.getOne = function (login, bookingId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, login.api.get(login.options.baseUrl + "/units/" + bookingId)];
                case 1:
    ...
    WialonUnit.getAll = function (login) { return __awaiter(void 0, void 0, void 0, function () {
        var responseData, data, meta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, login.api.get(login.options.baseUrl + "/units")];
                case 1:
                    responseData = (_a.sent()).data;
                    data = responseData.data, meta = __rest(responseData, ["data"]);

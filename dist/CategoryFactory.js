...
var CategoryFactory = /** @class */ (function (_super) {
    ...
    function CategoryFactory() {
        ...
        _this.getOne = function (id) {
            return Category_1.Category.getOne(_this, id);
        };
        _this.getAll = function () {
            return Category_1.Category.getAll(_this);
        };
        _this.create = function (clientData) {
            return Category_1.Category.create(_this, clientData);
        };
        _this.update = function (id, updatedCategoryData) {
            return Category_1.Category.update(_this, id, updatedCategoryData);
        };
        _this.destroy = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var responseData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.delete("/categories/" + id)];
                    case 1:
